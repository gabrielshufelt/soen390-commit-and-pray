...
export const DEV_OVERRIDE_TIME: Date | null = new Date('2026-03-09T08:00:00'); // UNCOMMENT TO USE OVERRIDE TIME
...
{ latitude: 45.4953, longitude: -73.5790 }; // UNCOMMENT TO USE OVERRIDE LOCATION
