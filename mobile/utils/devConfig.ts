...
export const DEV_OVERRIDE_TIME: Date | null = new Date('2026-03-09T16:00:00'); // UNCOMMENT TO USE OVERRIDE TIME
...
{ latitude: 45.4576, longitude: -73.6396 }; // UNCOMMENT TO USE OVERRIDE LOCATION
