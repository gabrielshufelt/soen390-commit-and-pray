  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {!directionsState.isActive && !directionsState.origin && startChoice && destChoice && (
          <MapViewDirections
            key={`selection-${startChoice.coordinate.latitude}-${startChoice.coordinate.longitude}-${destChoice.coordinate.latitude}-${destChoice.coordinate.longitude}-${directionsState.transportMode}`}
            origin={startChoice.coordinate}
        ...
        {!directionsState.isActive && directionsState.origin && directionsState.destination && destChoice && (startChoice || (location && !startChoice)) && (
          <MapViewDirections
            key={`preview-${directionsState.origin.latitude}-${directionsState.origin.longitude}-${directionsState.destination.latitude}-${directionsState.destination.longitude}-${directionsState.transportMode}`}
            origin={directionsState.origin}
            destination={directionsState.destination}
            apikey={apiKey}
            mode={directionsState.transportMode}
      ...
      {(directionsState.isActive || (!directionsState.isActive && directionsState.steps.length > 0)) && directionsState.steps.length > 0 && (
        <NavigationSteps
